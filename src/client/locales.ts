...
export const zh = {
  ...
  'panel.empty': '当前会话还没有侧边聊天。点击右上角「+」新建，或选中消息文本后点「在侧边聊天中提问」把内容带入输入框。',
  'panel.close': '关闭',
...
export const en = {
  ...
  'panel.empty': 'No side chat yet. Click "+" to start one, or select message text and choose "Ask in side chat" to bring it into the input.',
  'panel.close': 'Close',
