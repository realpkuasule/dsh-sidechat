 ...
 *
 * - `lib/client.js` registers with the package-name id `dsh-sidechat`
 *   (client-modules compose keys on the package name),
 * - `lib/client-registry.js` registers with the manifest id
 *   `dsh-external/dsh-sidechat` (dsh.plugin.json `client.main`).
 *
...
export default [
  ...
  clientBundle('dsh-external/dsh-sidechat', 'client-registry.js'),
